...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/12/10 14:53:32 by atrang            #+#    #+#             */
/*   Updated: 2015/12/11 10:47:48 by atrang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h>"

int			ft_check_tetri(int n)  // RECUPERE L INT DE RECUP TETRIS ET VERIFIE LES ID 
{
	long *tab;
	int i;
